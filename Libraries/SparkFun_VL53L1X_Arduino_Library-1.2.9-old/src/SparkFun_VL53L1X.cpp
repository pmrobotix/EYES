...
void SFEVL53L1X::setROI(uint8_t x, uint8_t y)
{
          _device->VL53L1X_SetROI(x, x);
}

void SFEVL53L1X::setROICenter(uint8_t x, uint8_t y, uint8_t center)
{
          _device->VL53L1X_SetROICenter(x, y, center);
}

void SFEVL53L1X::setCenter( uint8_t center)
{
          _device->VL53L1X_SetCenter(center);
}

void SFEVL53L1X::getResult(VL53L1X_Result_t *result) {
          _device->VL53L1X_GetResult(result);
}
